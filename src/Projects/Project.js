    ...
    <Container className="container card-container">
      ...
      <Row className="Card align-items-center shadow-lg mb-5 rounded">
        ...
        <Col sm={12} lg={6} className="built-with-col">
          ...
          <Row className="mt-4">
            <Col>
              <a href={deploy} aria-label='view demo' target="_blank" rel='noreferrer' className='btn btn-outline-dark deploy m-1'>Demo</a>
              <a href={github} aria-label='view github code' target="_blank" rel='noreferrer' className='btn btn-outline-dark github m-1'>Github</a>
            </Col>
